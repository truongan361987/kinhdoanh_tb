...
class CuaHang extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['so_nha', 'ten_duong', 'ten_phuong', 'so_sap', 'ten_cho', 'nam_hoatdong', 'nganh_kd', 'ma_nganh', 'tinhtrang_hd', 'tinhtrang_gp', 'kehoach_bienphap', 'doituong_didoi','giayphep_so'], 'string', 'max' => 100],
    ...
    public function attributeLabels() {
        return [
            ...
            'tinhtrang_gp' => 'Tình trạng giấy phép',
            'kehoach_bienphap' => 'Kế hoạch/Biện pháp phòng chống',
            'doituong_didoi' => 'Đối tượng di dời',
            'giayphep_ngay' => 'Ngày đăng ký giấy phép',
            'giayphep_so' => 'Số giấy phép',
            'geom' => 'Geom',
        ];
    }
