            ...
            <div class=" tab-pane active" id="thongtinchung">
                <div class="col-md-12 form-group" >
                    <table class="table table-responsive table-bordered table-striped">
                        ...
                        <tr>
                            <th>Giấy phép</th>
                            <td colspan="3"><?= ($model['cuahang']->giayphep_so== null) ? '(Chưa có)' : $model['cuahang']->giayphep_so ?></td>
                        </tr>
                        <tr>
                            <th>Ngày cấp</th>
                            <td colspan="3"><?= ($model['cuahang']->giayphep_ngay == null) ? '(Chưa có)' : $model['cuahang']->giayphep_ngay ?></td>
                        </tr>
                         <tr>
                            <th>Diện tích</th>
