                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    'options' => ['placeholder' => 'Ngày cấp ...',
                                            'value' => ($model['cuahang']->giayphep_ngay != null) ? date('d-m-Y', strtotime($model['cuahang']->giayphep_ngay)) : '',],
                                        'pluginOptions' => [
                                            'autoclose' => true,
                                            'format' => 'dd-mm-yyyy'
                                        ]
...
<script>
    $(document).ready(function () {
        ...
        reloadTable('#viphamTab', '<?= Yii::$app->urlManager->createUrl('cuahang/vipham?id=') . $model['cuahang']->id_cuahang ?>');
    });
    var map;
