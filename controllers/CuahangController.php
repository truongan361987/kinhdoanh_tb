 ...
 */
class CuahangController extends base\AbstractKinhdoanhq6Controller {
...
//            }
    ...
    public function actionView($id) {
        ...
        $model['vipham'] = ThongtinVipham::find()->where(['cuahang_id' => $id])->orderBy('id_ttvp')->all();
    ...
    public function actionCreate() {
        ...
        if ($model['cuahang']->load($request->post())) {
            $model['cuahang']->save();
            UtilityService::alert('cuahang_create_success');
    ...
    public function actionUpdate($id) {
        ...
        $model['giaothong'] = GiaoThong::find()->orderBy('ten_duong')->distinct()->all();
        if ($model['cuahang']->load($request->post())) {
             if ($model['cuahang']->giayphep_ngay != null) {
                $model['cuahang']->giayphep_ngay = date('Y-m-d', strtotime($model['cuahang']->giayphep_ngay));
            }
            ...
            $model['cuahang']->save();
            UtilityService::alert('cuahang_update_success');
    ...
    public function actionVipham($id) {
        if (!UtilityService::paramValidate($id)) {
            return $this->redirect(Yii::$app->urlManager->createUrl('cuahang'));
        }
